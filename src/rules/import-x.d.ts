...
export interface ImportXRules {
   ...
   * @see [no-namespace](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-namespace.md)
   */
   ...
   * @see [no-mutable-exports](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-mutable-exports.md)
   */
  'import-x/no-mutable-exports': null;

  /**
   * Ensure consistent use of file extension within the import path.
   * @see [extensions](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/extensions.md)
   */
  'import-x/extensions': ExtensionsOption;

  /**
   * Enforce which files can be imported in a given folder.
   * @see [no-restricted-paths](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-restricted-paths.md)
   */
  'import-x/no-restricted-paths': [NoRestrictedPathsOption?];

  /**
   * Forbid importing the submodules of other modules.
   * @see [no-internal-modules](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-internal-modules.md)
   */
  'import-x/no-internal-modules': [NoInternalModulesOption?];

  /**
   * Prefer named exports to be grouped together in a single export declaration.
   * @see [group-exports](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/group-exports.md)
   */
  'import-x/group-exports': null;

  /**
   * Forbid importing packages through relative paths.
   * @see [no-relative-packages](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-relative-packages.md)
   */
  'import-x/no-relative-packages': [NoRelativePackagesOption?];

  /**
   * Forbid importing modules from parent directories.
   * @see [no-relative-parent-imports](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-relative-parent-imports.md)
   */
  'import-x/no-relative-parent-imports': [NoRelativeParentImportsOption?];

  /**
   * Enforce or ban the use of inline type-only markers for named imports.
   * @see [consistent-type-specifier-style](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/consistent-type-specifier-style.md)
   */
   ...
   * @see [no-self-import](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-self-import.md)
   */
  'import-x/no-self-import': null;

  /**
   * Forbid a module from importing a module with a dependency path back to itself.
   * @see [no-cycle](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-cycle.md)
   */
  'import-x/no-cycle': [NoCycleOption?];

  /**
   * Forbid named default exports.
   * @see [no-named-default](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-named-default.md)
   */
   ...
   * @see [no-anonymous-default-export](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-anonymous-default-export.md)
   */
   ...
   * @see [no-unused-modules](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-unused-modules.md)
   */
  'import-x/no-unused-modules': NoUnusedModules.NoUnusedModulesRuleConfig;

  /**
   * Forbid CommonJS `require` calls and `module.exports` or `exports.*`.
   * @see [no-commonjs](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-commonjs.md)
   */
  'import-x/no-commonjs': NoCommonjsOption;

  /**
   * Forbid AMD `require` and `define` calls.
   * @see [no-amd](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-amd.md)
   */
   ...
   * @see [first](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/first.md)
   */
  'import-x/first': [('absolute-first' | 'disable-absolute-first')?];

  /**
   * Enforce the maximum number of dependencies a module can have.
   * @see [max-dependencies](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/max-dependencies.md)
   */
   ...
   * @see [no-extraneous-dependencies](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-extraneous-dependencies.md)
   */
  'import-x/no-extraneous-dependencies': [NoExtraneousDependenciesOption?];

  /**
   * Forbid import of modules using absolute paths.
   * @see [no-absolute-path](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-absolute-path.md)
   */
  'import-x/no-absolute-path': [NoAbsolutePathOption?];

  /**
   * Forbid Node.js builtin modules.
   * @see [no-nodejs-modules](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-nodejs-modules.md)
   */
   ...
   * @see [no-webpack-loader-syntax](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-webpack-loader-syntax.md)
   */
  'import-x/no-webpack-loader-syntax': null;

  /**
   * Enforce a convention in module import order.
   * @see [order](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/order.md)
   */
  'import-x/order': Order.OrderRuleConfig;

  /**
   * Enforce a newline after import statements.
   * @see [newline-after-import](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/newline-after-import.md)
   */
   ...
   * @see [prefer-default-export](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/prefer-default-export.md)
   */
  'import-x/prefer-default-export': [PreferDefaultExportOption?];

  /**
   * Enforce using namespace imports for specific modules, like `react`/`react-dom`, etc.
   * @see [prefer-namespace-import](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/prefer-namespace-import.md)
   */
   ...
   * @see [no-default-export](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-default-export.md)
   */
  'import-x/no-default-export': null;

  /**
   * Forbid named exports.
   * @see [no-named-export](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-named-export.md)
   */
  'import-x/no-named-export': null;

  /**
   * Forbid `require()` calls with expressions.
   * @see [no-dynamic-require](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-dynamic-require.md)
   */
   ...
   * @see [unambiguous](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/unambiguous.md)
   */
  'import-x/unambiguous': null;

  /**
   * Forbid unassigned imports.
   * @see [no-unassigned-import](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-unassigned-import.md)
   */
  'import-x/no-unassigned-import': [NoUnassignedImportOption?];

  /**
   * Forbid unnecessary path segments in import and require statements.
   * @see [no-useless-path-segments](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-useless-path-segments.md)
   */
   ...
   * @see [dynamic-import-chunkname](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/dynamic-import-chunkname.md)
   */
  'import-x/dynamic-import-chunkname': [DynamicImportChunknameOption?];

  /**
   * Forbid import statements with CommonJS module.exports.
   * @see [no-import-module-exports](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-import-module-exports.md)
   */
   ...
   * @see [no-empty-named-blocks](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/no-empty-named-blocks.md)
   */
  'import-x/no-empty-named-blocks': null;

  /**
   * Ensure all exports appear after other statements.
   * @see [exports-last](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/exports-last.md)
   */
   ...
   * @deprecated
   * @see [imports-first](https://github.com/un-ts/eslint-plugin-import-x/blob/v4.16.1/docs/rules/imports-first.md)
   */
