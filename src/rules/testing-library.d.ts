...
export interface TestingLibraryRules {
   ...
   */
  'testing-library/no-node-access': [NoNodeAccessOption?];
   ...
   */
  'testing-library/no-unnecessary-act': [NoUnnecessaryActOption?];
   ...
   */
  'testing-library/prefer-user-event': [PreferUserEventOption?];
