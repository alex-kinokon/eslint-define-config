...
export interface TestingLibraryRules {
   ...
   * @preset `testing-library/dom`, `testing-library/angular`, `testing-library/react`, `testing-library/vue`, `testing-library/svelte`, `testing-library/marko`, `testing-library/flat/dom`, `testing-library/flat/angular`, `testing-library/flat/react`, `testing-library/flat/vue`, `testing-library/flat/svelte`, `testing-library/flat/marko`
   ...
   * @preset `testing-library/dom`, `testing-library/angular`, `testing-library/react`, `testing-library/flat/dom`, `testing-library/flat/angular`, `testing-library/flat/react`
   ...
   * @preset `testing-library/angular`, `testing-library/react`, `testing-library/vue`, `testing-library/svelte`, `testing-library/marko`, `testing-library/flat/angular`, `testing-library/flat/react`, `testing-library/flat/vue`, `testing-library/flat/svelte`, `testing-library/flat/marko`
   ...
   * @preset `testing-library/react`, `testing-library/vue`, `testing-library/svelte`, `testing-library/flat/react`, `testing-library/flat/vue`, `testing-library/flat/svelte`
   ...
   * @preset `testing-library/react`, `testing-library/marko`, `testing-library/flat/react`, `testing-library/flat/marko`
