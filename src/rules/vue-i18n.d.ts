...
export type NoUnknownLocaleRuleConfig = [
  {
    locales?: string[];
...
export type NoUnusedKeysRuleConfig = [
  {
    src?: string;
    extensions?: string[];
    ignores?: string[];
...
export interface VueI18nRules {
   ...
   */
  '@intlify/vue-i18n/key-format-style': RuleConfig<KeyFormatStyleRuleConfig>;
   ...
   */
  '@intlify/vue-i18n/no-deprecated-i18n-component': EmptyRuleConfig;
   ...
   */
  '@intlify/vue-i18n/no-deprecated-i18n-place-attr': EmptyRuleConfig;
   ...
   */
  '@intlify/vue-i18n/no-deprecated-i18n-places-prop': EmptyRuleConfig;
   ...
   */
  '@intlify/vue-i18n/no-deprecated-modulo-syntax': EmptyRuleConfig;
   ...
   */
  '@intlify/vue-i18n/no-deprecated-tc': EmptyRuleConfig;
   ...
   */
  '@intlify/vue-i18n/no-duplicate-keys-in-locale': RuleConfig<
    [
      {
   ...
   */
  '@intlify/vue-i18n/no-dynamic-keys': EmptyRuleConfig;
   ...
   */
  '@intlify/vue-i18n/no-html-messages': EmptyRuleConfig;
   ...
   */
  '@intlify/vue-i18n/no-i18n-t-path-prop': EmptyRuleConfig;
   ...
   */
  '@intlify/vue-i18n/no-missing-keys-in-other-locales': RuleConfig<
    [
      {
   ...
   */
  '@intlify/vue-i18n/no-missing-keys': EmptyRuleConfig;
   ...
   */
  '@intlify/vue-i18n/no-v-html': EmptyRuleConfig;
   ...
   */
  '@intlify/vue-i18n/prefer-linked-key-with-paren': EmptyRuleConfig;
   ...
   */
  '@intlify/vue-i18n/prefer-sfc-lang-attr': EmptyRuleConfig;
   ...
   */
  '@intlify/vue-i18n/sfc-locale-attr': RuleConfig<[('always' | 'never')?]>;
   ...
   */
  '@intlify/vue-i18n/valid-message-syntax': RuleConfig<
    [
      {
