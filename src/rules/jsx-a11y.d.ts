...
export interface JsxA11yRules {
   ...
   */
  'jsx-a11y/anchor-ambiguous-text': RuleConfig<[AnchorAmbiguousTextOption?]>;
   ...
   */
  'jsx-a11y/aria-activedescendant-has-tabindex': RuleConfig<
   ...
   */
  'jsx-a11y/aria-unsupported-elements': RuleConfig<
    [AriaUnsupportedElementsOption?]
  >;
   ...
   */
  'jsx-a11y/autocomplete-valid': RuleConfig<[AutocompleteValidOption?]>;
   ...
   */
  'jsx-a11y/click-events-have-key-events': RuleConfig<
    [ClickEventsHaveKeyEventsOption?]
  >;
   ...
   */
  'jsx-a11y/control-has-associated-label': RuleConfig<
   ...
   */
  'jsx-a11y/heading-has-content': RuleConfig<[HeadingHasContentOption?]>;

  /**
   * Enforce `<html>` element has `lang` prop.
   * @see [html-has-lang](https://github.com/jsx-eslint/eslint-plugin-jsx-a11y/tree/HEAD/docs/rules/html-has-lang.md)
   */
  'jsx-a11y/html-has-lang': RuleConfig<[HtmlHasLangOption?]>;
   ...
   */
  'jsx-a11y/iframe-has-title': RuleConfig<[IframeHasTitleOption?]>;
   ...
   */
  'jsx-a11y/img-redundant-alt': RuleConfig<[ImgRedundantAltOption?]>;
   ...
   */
  'jsx-a11y/interactive-supports-focus': RuleConfig<
    [InteractiveSupportsFocusOption?]
  >;
   ...
   */
  'jsx-a11y/label-has-associated-control': RuleConfig<
   ...
   */
  'jsx-a11y/media-has-caption': RuleConfig<[MediaHasCaptionOption?]>;
   ...
   */
  'jsx-a11y/mouse-events-have-key-events': RuleConfig<
    [MouseEventsHaveKeyEventsOption?]
  >;
   ...
   */
  'jsx-a11y/no-access-key': RuleConfig<[NoAccessKeyOption?]>;
   ...
   */
  'jsx-a11y/no-aria-hidden-on-focusable': RuleConfig<
    [NoAriaHiddenOnFocusableOption?]
  >;
   ...
   */
  'jsx-a11y/no-autofocus': RuleConfig<[NoAutofocusOption?]>;
   ...
   */
  'jsx-a11y/no-distracting-elements': RuleConfig<
    [NoDistractingElementsOption?]
  >;
   ...
   */
  'jsx-a11y/no-interactive-element-to-noninteractive-role': RuleConfig<
   ...
   */
  'jsx-a11y/no-noninteractive-element-interactions': RuleConfig<
   ...
   */
  'jsx-a11y/no-noninteractive-element-to-interactive-role': RuleConfig<
   ...
   */
  'jsx-a11y/no-noninteractive-tabindex': RuleConfig<
    [NoNoninteractiveTabindexOption?]
  >;
   ...
   */
  'jsx-a11y/no-onchange': RuleConfig<[NoOnchangeOption?]>;
   ...
   */
  'jsx-a11y/no-redundant-roles': RuleConfig<[NoRedundantRolesOption?]>;
   ...
   */
  'jsx-a11y/no-static-element-interactions': RuleConfig<
   ...
   */
  'jsx-a11y/prefer-tag-over-role': RuleConfig<[PreferTagOverRoleOption?]>;
   ...
   */
  'jsx-a11y/role-has-required-aria-props': RuleConfig<
    [RoleHasRequiredAriaPropsOption?]
  >;
   ...
   */
  'jsx-a11y/role-supports-aria-props': RuleConfig<
    [RoleSupportsAriaPropsOption?]
  >;
   ...
   */
  'jsx-a11y/scope': RuleConfig<[ScopeOption?]>;
   ...
   */
  'jsx-a11y/tabindex-no-positive': RuleConfig<[TabindexNoPositiveOption?]>;
}
